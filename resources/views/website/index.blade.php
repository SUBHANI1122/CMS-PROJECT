                ...
                <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-2 mb-5 text-center">
                    ...
                    <form class="form-inline position-relative">
                        <div class="form-group fables-subscribe-formgroup">
                            <input type="email" class="form-control fables-subscribe-input rounded-0" placeholder="Your Email">
                        </div>
                        <button type="submit" class="btn fables-second-background-color rounded-0 fables-subscribe-btn">Subscribe</button>
                    </form>
